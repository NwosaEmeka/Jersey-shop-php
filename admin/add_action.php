    ...
    //check if the file type is supported
      if(in_array($filetype, $allowedFiles)){
        if(move_uploaded_file($temp_name, $targetFilePath)){
          $sql = "INSERT INTO products(product_name,product_desc,product_img,price,club,brand,quantity, admin_id) VALUES (:product_name,:product_desc,:image,:price,:club,:brand,:quantity, :admin_id)";
